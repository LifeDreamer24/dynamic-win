...
public class SettingsMenu : BaseMenu
{
    ...
    void SaveAndBack()
    {
        ...
        if (runOnStartup.IsChecked)
            StartupShortcutManager.TryCreateShortcut();
        else
            StartupShortcutManager.TryRemoveShortcut();

        if (changedTheme)
            Theme.Instance.UpdateTheme(true);
        else
        {
            Resources.FileResources.HomeMenu = new HomeMenu();
    ...
    public override List<UIObject> InitializeMenu(IslandObject island)
    {
        ...
        generalTitle.Font = Resources.FileResources.InterBold;
...

        {
            ...
            islandModesTitle.Font = Resources.FileResources.InterRegular;
...

        {
            ...
            selectedMonitorTitle.Font = Resources.FileResources.InterRegular;
...

        {
            ...
            themeTitle.Font = Resources.FileResources.InterRegular;
        ...
        widgetsTitle.Font = Resources.FileResources.InterBold;
...

        {
            ...
            wTitle.Font = Resources.FileResources.InterRegular;
        ...
        widgetOptionsTitle.Font = Resources.FileResources.InterBold;
            ...
            foreach(var option in customOptions)
            {
                ...
                foreach(var optionItem in option.SettingsObjects())
                {
                    ...
                    if (optionItem is DWText)
                    {
                        ...
                        ((DWText)optionItem).Font = Resources.FileResources.InterRegular;
        ...
        objects.Add(new DWText(island, "Software version: " + App.Version, new Vec2(25, 0), UIAlignment.TopLeft)
        {
            Color = Theme.TextThird,
            Anchor = new Vec2(0, 0.5f),
            TextSize = 15
        ...
        backBtn.Text.Font = Resources.FileResources.InterBold;
    ...
    public override Color IslandBorderColor()
    {
        ...
        if (mode == IslandMode.Island) return new Color(0.5f, 0.5f, 0.5f);
        else return new Color(0, 0, 0, 0); // Render transparent if island mode is Notch
    }
}
...
internal class BigWidgetAdder : UIObject
{
    ...
    public override ContextMenu? GetContextMenu()
    {
        ...
        foreach (var availableWidget in Resources.FileResources.availableBigWidgets)
        {
...
internal class AddNew : UIObject
{
    ...
    {
        AddLocalObject(new DWImage(this, Resources.FileResources.Add, Vec2.zero, new Vec2(15, 15), UIAlignment.Center)
        {
...
internal class SmallWidgetAdder : UIObject
{
    ...
    public override ContextMenu? GetContextMenu()
    {
        ...
        foreach (var availableWidget in Resources.FileResources.availableSmallWidgets)
        {
...
public class Checkbox : DWImageButton
{
    ...
    void SetChecked(bool isChecked)
    {
        ...
        Image.Image = isChecked ? Resources.FileResources.Check : null;
    }

    public Checkbox(UIObject? parent, string buttonText, Vec2 position, Vec2 size, Action clickCallback, UIAlignment alignment = UIAlignment.TopCenter) : base(parent, Resources.FileResources.Check, position, size, clickCallback, alignment)
    {
