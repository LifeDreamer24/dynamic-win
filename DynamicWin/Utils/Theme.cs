...
public class Theme
{
    ...
    public static Color TextMain { get; set; }
    public static Color TextSecond { get; set; }
    public static Color TextThird { get; set; }
    public static Color Primary { get; set; }
    public static Color Secondary { get; set; }
    public static Color IslandBackground { get; set; }
    public static Color Success { get; set; }
    public static Color Error { get; set; }
    public static Color IconColor { get; set; }
    public static Color WidgetBackground { get; set; }
}
